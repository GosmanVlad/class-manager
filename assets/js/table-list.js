function showStudentsTable(year, group = 'A', teacher, course) {
  if (group == "") {
...
function selectGroupTable(value, teacher, course) {
  showStudentsTable(this.document.getElementById('year').value, this.document.getElementById('group').value, teacher, course);
}