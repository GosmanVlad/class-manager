    ...
    <div class="background-color">
        ...
        <div class="cal-box">
            <form name="calculator">
                ...
                <input class="button-calc mathbutton" type="button" name="button" value="+"
                ...
                <input class="button-calc mathbutton" type="button" name="button" value="x"
                    onclick="calculator.display.value +='*'">
                <br>
                <input class="button-calc clearButton" type="button" name="button" value="C"
                    onclick="calculator.display.value =''">
